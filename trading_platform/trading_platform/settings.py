...
SECRET_KEY = "django-insecure-v9#x^v$@ob0*fm-_4n*!$c(flg$-8-(*trc7gqine&^8$bumu#"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'TradingPlatform',       # The name of your database
        'USER': 'haquewasif',       # Your postgres username
        'PASSWORD': '55TTww$$', # Your postgres password
